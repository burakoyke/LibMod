...
public class BunchFileConverter {
    ...
    public static void main(String[] args) {
        String inputFilePath = "packages_packages_dependencies.txt.bunch"; // Giriş dosyasının yolu
        String outputFilePath = "log4j_packages_class_dependencies_bunch_sahc.rsf"; // Çıktı dosyasının yolu
